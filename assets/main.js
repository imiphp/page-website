...
/* 这里一些常量,用于定义一些设置 */
var lunbo_time = 5000; // 轮播速度

function leave(func, runtime) {
  var timer = setInterval(func, runtime);
...
$(function () {
  ...
  leave(func, lunbo_time); // 打乱公司列表

  $('.anli_company_list > div').sort(function () {
    return Math.random() - 0.5;
  }).detach().appendTo('.anli_company_list'); // 随机公司logo颜色
...
(function (root, factory) {
  ...
  if (( false ? 0 : _typeof(module)) === 'object' && _typeof(module.exports) === 'object') {
    factory(__webpack_require__(755), root);
  }

  if (true) {
    if (__webpack_require__.amdD.cmd) {
      ...
      !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(755)], __WEBPACK_AMD_DEFINE_RESULT__ = (function ($) {
        factory($, root);
  ...
  function mModal(options) {
    options = options || {};
    this.options = $.extend(true, {}, mModal.defaultOptions, options); // this.renderDom();
  }
  ...
  mModal.prototype = {
    ...
    initElement: function initElement() {
      ...
      mWrapper.className = "m-modal__wrapper"; // 2. 创建 m-modal__container 并且 append m-modal__wrapper

      var mContainer = document.createElement("div");
      mContainer.className = "m-modal__container";
      mWrapper.appendChild(mContainer); // 3. 创建 m-modal__header

      var mHeader = document.createElement("div");
      mHeader.className = "m-modal__header"; // 4. 创建 title close 并且 append m-modal__header
      ...
      mHeader.appendChild(mHeaderbtn); // 5. 创建 m-modal__body

      var mBody = document.createElement("div");
      mBody.className = "m-modal__body";
      var mBodySpan = document.createElement("div");
      mBody.appendChild(mBodySpan); // 6. 创建 m-modal__footer

      var mFooter = document.createElement("div");
      mFooter.className = "m-modal__footer"; // 7. 创建 操作按钮
      ...
      mFooter.appendChild(mButtonRight).appendChild(mBtnSpanR); // 8. header body footer append m-modal__container

      mContainer.appendChild(mHeader);
      mContainer.appendChild(mBody);
      mContainer.appendChild(mFooter);
      document.body.appendChild(mWrapper); // 返回可能用到的dom
      ...
      this.mTitle = mTitle; // return this;
    },
...
module.exports = __webpack_require__.p + "assets/images/pay.png";
...
module.exports = __webpack_require__.p + "assets/images/wechat.jpg";
...
module.exports = __webpack_require__.p + "assets/images/yunzhimeng.ico";
...
module.exports = __webpack_require__.p + "assets/images/zhihu.ico";
...
;// CONCATENATED MODULE: ./src/js/jquery-vendor.js

window.$ = (jquery_default());
window.jQuery = (jquery_default());
/* harmony default export */ const jquery_vendor = ((/* unused pure expression or super */ null && ($)));
// EXTERNAL MODULE: ./src/util.js
var util = __webpack_require__(72);
// EXTERNAL MODULE: ./src/js/modal.js
var modal = __webpack_require__(619);
// EXTERNAL MODULE: ./src/images/pay.png
var pay = __webpack_require__(227);
// EXTERNAL MODULE: ./src/images/wechat.jpg
var wechat = __webpack_require__(590);
...
var modalWechat = new mModal({
  title: "",
  width: "30%",
  content: "<p style=\"text-align:center;\"><img src=\"" + (wechat_default()) + "\"></p>",
  confirmText: "确定",
  // 确定按钮文本
  showCancelButton: false,
  // 是否显示取消按钮
    ...
    $('#donate-form').on('submit', function (e) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          browser.toDataURL(data.jumpUrl, {
            errorCorrectionLevel: 'H',
            margin: 1,
            width: 256
          }).then(function (url) {
            var modalQR = new mModal({
              title: "",
              width: "30%",
...
// EXTERNAL MODULE: ./src/cases.js
var cases = __webpack_require__(336);
// EXTERNAL MODULE: ./src/index.js
var src = __webpack_require__(183);
// EXTERNAL MODULE: ./src/images/yunzhimeng.ico
var yunzhimeng = __webpack_require__(469);
// EXTERNAL MODULE: ./src/images/zhihu.ico
var zhihu = __webpack_require__(348);
;// CONCATENATED MODULE: ./src/course.js


;// CONCATENATED MODULE: ./src/donate.js
 ...
 * @Author       : lovefc
 * @Date         : 2021-08-31 14:36:35
 * @LastEditTime : 2021-10-12 15:01:10
 */
